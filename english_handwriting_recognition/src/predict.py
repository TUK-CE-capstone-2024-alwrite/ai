...
class PredictionEngine:
    ...
    def __init__(self):
        self.model = Model()
        load_model("C:/minji/english-handwriting-recognition/src/models/main.pth", self.model, opt=None, with_opt=False)
...
if __name__ == "__main__":
    ...
    img = cv2.imread("C:/minji/english-handwriting-recognition/data/paragraph.png")
